	            ...
	            <div class="box">
	                <div class="box-body">
	                    <div class="btn-group pull-right" style="margin-bottom:5px;">
      						<button type="button" id="locale_ko" onclick="location.href='${pageContext.request.contextPath}/admin/business/getBusinessPostList?locale=ko&businessNo=${businessNo}'" class="btn btn-primary"><i class="fa fa-globe" aria-hidden="true"></i> 한국어</button>   
      						<button type="button" id="locale_en" onclick="location.href='${pageContext.request.contextPath}/admin/business/getBusinessPostList?locale=en&businessNo=${businessNo}'" class="btn btn-default"><i class="fa fa-globe" aria-hidden="true"></i> ENG</button>                    
      					</div>                                 
